    ...
    <div className="sidebar mt-5">
      ...
      <div className="form-check">
        <input
          ...
          id="check11"
          value="1-2500"
          defaultChecked={checkHandler("salary", "1-2500")}
          onClick={(e) => handleClick(e.target)}
        />
      ...
      <div className="form-check">
        <input
          ...
          id="check12"
          value="2500-6000"
          defaultChecked={checkHandler("salary", "2500-6000")}
          onClick={(e) => handleClick(e.target)}
        />
      ...
      <div className="form-check">
        <input
          ...
          id="check13"
          value="6000-10000"
          defaultChecked={checkHandler("salary", "6000-10000")}
          onClick={(e) => handleClick(e.target)}
        />
      ...
      <div className="form-check">
        <input
          ...
          id="defaultCheck2"
          value="10000-18000"
          defaultChecked={checkHandler("salary", "10000-18000")}
          onClick={(e) => handleClick(e.target)}
        />
      ...
      <div className="form-check">
        <input
          ...
          id="check14"
          value="18000-25000"
          defaultChecked={checkHandler("salary", "18000-25000")}
          onClick={(e) => handleClick(e.target)}
        />
